...
public class SmasherScreen extends AbstractContainerScreen<SmasherMenu> {
    // 指向你的 GUI 贴图路径：src/main/resources/assets/smasher/textures/gui/smasher_gui.png
    private static final ResourceLocation TEXTURE = 
            ResourceLocation.fromNamespaceAndPath("smasher", "textures/gui/smasher_gui.png");

    public SmasherScreen(SmasherMenu menu, Inventory playerInv, Component title) {
