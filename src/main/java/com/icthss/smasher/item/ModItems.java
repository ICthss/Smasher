...
public class ModItems {
    ...
    public static final DeferredItem<Item> HOLLOW_WOOD_COAL = ITEMS.register("hollow_wood_coal", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> AIRPODS = ITEMS.register("airpods", () -> new Item(new Item.Properties()));
